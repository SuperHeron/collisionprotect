...
#ifndef __CONTENTS_VISITOR_FOR_IFL_HH__
#define __CONTENTS_VISITOR_FOR_IFL_HH__
...
class ContentsVisitorForIFL
{
    public:
        ContentsVisitorForIFL(std::string, FilesList*, const std::tr1::shared_ptr<const paludis::PackageID>&);
...
#endif // __CONTENTS_VISITOR_FOR_IFL_HH__
